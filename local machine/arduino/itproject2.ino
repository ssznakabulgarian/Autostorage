...
void loop() {
  ...
  ////////////////////////////////////////////////////////
  while(true) {
    command=Serial.read();    if(command == -1) continue;
  ...
  else if(command=='r'){Serial.print("Y :");G28(0);Serial.print("Z :");G28(1);Serial.print("X :");G28_1(2);Serial.println("r");Serial.print("\n");}
  else if(command=='m'){
            Serial.print("FROMX :");
             while(true) {
              fx=Serial.read();
